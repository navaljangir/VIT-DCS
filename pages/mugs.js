...
const Mugs = ({ products }) => {
  ...
  return (
    <div>
      <Head>
        <title>Buy Mugs - Codeswear</title>
      </Head>
                  ...
                  >
                    <div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-5">
                      <a className="block relative  rounded overflow-hidden">
                        <img alt="ecommerce" className="h-[30vh] md:h-[22vh] m-auto " src={products[item].img}/>
                      </a>
                      <div className="mt-4 text-center md:text-left">
                        ...
                        <div className="mt-1">
                          ...
                          {products[item].color.includes("yellow") && (
                            <button
                              className={`border-2 border-gray-300 ml-1 bg-yellow-400 rounded-full w-6 h-6 focus:outline-none`}
                            ></button>
                          )}
                        </div>
                      </div>
